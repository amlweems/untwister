...
BOOST = /usr/include
OBJS = ./prngs/LSBState.o ./prngs/GlibcRand.o ./prngs/PHP_mt19937.o ./prngs/Mt19937.o ./prngs/Ruby.o ./prngs/Java.o ./prngs/Newlib.o ./prngs/Wiced.o ./prngs/PRNGFactory.o ./Untwister.o
...
all: GlibcRand Mt19937 PHP_mt19937 Ruby Java Newlib Wiced LSBState PRNGFactory Untwister
	$(CC) $(CPPFLAGS) -pthread -MF"main.d" -MT"main.d" -o "main.o" "./main.cpp"
	$(CC) -std=gnu++11 -O3 -pthread $(OBJS) main.o -o untwister

python: GlibcRand Mt19937 PHP_mt19937 Ruby Java Newlib Wiced LSBState PRNGFactory Untwister
...
Newlib:
	$(CC) $(CPPFLAGS) -MF"prngs/Newlib.d" -MT"prngs/Newlib.d" -o "prngs/Newlib.o" "./prngs/Newlib.cpp"

Wiced:
	$(CC) $(CPPFLAGS) -MF"prngs/Wiced.d" -MT"prngs/Wiced.d" -o "prngs/Wiced.o" "./prngs/Wiced.cpp"
